...
cat("For Simulation Run One the scores are: ", '\n',
    "The mean difference for simple imputer col1 :", simple_imputer_one_results[[1]]$mean, "col2 :", simple_imputer_one_results[[2]]$mean, '\n',
    "The mean difference for mice col1 :", mice_result_one$mean$cont0, "col2 :", mice_result_one$mean$cont1, '\n',
    "The mean difference for missForest col1 :", missForest_result_one$mean[[1]], "col2 :", missForest_result_one$mean[[2]], '\n',
    "The sd difference for simple imputer col1 :", simple_imputer_one_results[[1]]$sd, "col2 :", simple_imputer_one_results[[2]]$sd, '\n',
    "The sd difference for mice col1 :", mice_result_one$sd$cont0, "col2 :", mice_result_one$sd$cont1, '\n',
    "The sd difference for missForest col1 :", missForest_result_one$sd[[1]], "col2 :", missForest_result_one$sd[[2]])
...
plot_col <- c(mice_result_one$D$cont0[[1]])
plot_col_two <- c(missForest_result_one$D$cont0)
